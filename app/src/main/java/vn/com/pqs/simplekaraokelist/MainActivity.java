...
if(objects.getTenviettat().toLowerCase().contains(newText)){
 ...
 if(position==0){toolbar.setVisibility(View.VISIBLE);
     toolbar.setTitle("");
 }

 if(position==1){toolbar.removeView(searchView);
     toolbar.setTitle("YEU THICH");
}

if(position==2){toolbar.setVisibility(View.INVISIBLE);}
